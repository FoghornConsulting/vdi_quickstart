...
variable "aadds_vnet_rg_name" {
  description = "The name of the resource group that contains AADDS vnet"
}

variable "aadds_vnet_name" {
  description = "The name of the AADDS virtual network"
}

variable "wvd_vnet_name" {
  description = "The name of the WVD vnet"
}

variable "wvd_address_space" {
  type = list(string)
}

variable "wvd_address_prefix" {
  description = "The subnet prefix using CIDR notation for the WVD subnet"
}
